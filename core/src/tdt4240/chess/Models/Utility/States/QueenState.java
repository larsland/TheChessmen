...
public class QueenState implements tdt4240.chess.Models.Utility.ChessmanState {
    @Override
    public List<tdt4240.chess.Models.Utility.Tuple> getLegalMoves(tdt4240.chess.Models.Utility.ChessmanColor chessmanColor) {
        ...
        for (int i = 1; i < 9; i++) {
            ...
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(i, -i));
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(-i, i));
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(i, 0));
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(-i, 0));
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(0, i));
            legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(0, -i));
        }
        return legalMoves;
    }
