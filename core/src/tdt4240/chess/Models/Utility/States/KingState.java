...
public class KingState implements tdt4240.chess.Models.Utility.ChessmanState {
    @Override
    public List<tdt4240.chess.Models.Utility.Tuple> getLegalMoves(tdt4240.chess.Models.Utility.ChessmanColor chessmanColor) {
        ...
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(1, 0));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(0, 1));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(1, 1));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(-1, -1));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(-1, 1));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(1, -1));
        legalMoves.add(new tdt4240.chess.Models.Utility.Tuple(-1, 0));
